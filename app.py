...
st.set_page_config(page_title="Elegance Store",page_icon="👗🛍️",layout="wide",initial_sidebar_state="collapsed")
    ...
    try:
        ...
        if doc.exists:
            ...
            nuevo_usuario = {
                ...
                'edad' : None, # Se completará después
                'telefono' : None, # verificación aparte
                'genero' : None, #'Masculino', 'Femenino', 'Otro'
                'preferencias' : [], # Lista de strings (ej: ["tech", "libros"])
                'lista de deseos' : [], # Lista de IDs de productos
                'perfil_completo': False,  # validar después!
    ...
    if not code:
        ...
        <div class="main-container">
            <div class="login-card">
                <div class="brand-logo">ELEGANCE STORE</div>
